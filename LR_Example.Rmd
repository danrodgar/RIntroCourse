...
Example of a linear regression model in Software Engineering, we will use ISBSG dataset.
...
Descritive statistics of the dataset (actually a dataframe in R)
...
1. As exercise, we suggest using testing the model using a testing dataset, i.e., divide the dataset into training and testing.

2. As the data is quite skew and it does no follow a normal distribution, a possible solution is to transform the data using logarithms and repeat the process.
